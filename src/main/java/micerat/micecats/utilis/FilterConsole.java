...
public class FilterConsole implements Filter {
    ...
    public Filter.Result checkMessage(String message) {
        if (
                message.contains("Could not save data net.minecraft.world.entity.raid") || message.contains("Failed to save level") || message.contains("Could not save data net.minecraft.world")) {
